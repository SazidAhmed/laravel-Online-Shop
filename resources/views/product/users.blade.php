...
<div id="addModalpro" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form class="floating-labels m-t-40" id="proForm" action="{{route('users.store')}}" method="post" enctype="multipart/form-data">@csrf
      <div class="modal-content">
        <div class="ribbon-wrapper">
          <div class="ribbon ribbon-bookmark ribbon-primary">Create New User</div>
        </div>
        <div class="modal-body">
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="uname" name="name"><span class="bar"></span>
            <label for="uname">Name</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="uemail" name="email"><span class="bar"></span>
            <label for="uemail">Email</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="upassword" name="password"><span class="bar"></span>
            <label for="upassword">Password</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="uphone" name="phone"><span class="bar"></span>
            <label for="uphone">Mobile</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="uaddress" name="address"><span class="bar"></span>
            <label for="uaddress">Address</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="urole" name="is_admin"><span class="bar"></span>
