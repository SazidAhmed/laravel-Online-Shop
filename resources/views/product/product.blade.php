          ...
          <div class="align-self-center">
            <table class="table table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$key+1}}</td>
                  <td><img src="storage/product/{{$product->image}}" height="80"></td>
                  <td>{{$product->name}}</td>
                  <td>{{$product->price}}</td>
                  <td>{{$product->stock}}</td>
              ...
              <table class="table table-responsive">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="storage/product/{{$product->image}}" height="80" width="100"></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group has-success m-b-40">
            ...
            <label for="eprodes">Description</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="proaddinfo" name="additional_info" value="{{$product->additional_info}}"><span class="bar"></span>
            <label for="proaddinfo">Additional Info</label>
          </div>
          <div class="form-group has-success m-b-40">
    ...
    <form class="floating-labels m-t-40" id="proForm" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">@csrf
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="proprice" name="price"><span class="bar"></span>
            <label for="proprice">Price</label>
          </div>
          <div class="form-group has-success m-b-40">
            <input type="text" class="form-control" id="prostock" name="stock"><span class="bar"></span>
